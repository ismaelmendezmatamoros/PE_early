...
void PE_TaskScheduler::loopCycle() {
	...
	bool empty;
	while (!exit) {																						//checks if the loop should terminate
...
const MILISECONDS_TIPE PE_TaskScheduler::makeTriggerTime(MILISECONDS_TIPE time, unsigned int delay) { return time + (delay * tics_per_milisecond); }
